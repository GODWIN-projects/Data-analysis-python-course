...
def calculate_demographic_data(print_data=True):
    ...
    l = df.shape[0]
    percentage_bachelors = ((df["education"].value_counts().get("Bachelors")/l)*100).round(1)
    ...
    higher_education = df[df["education"].isin(degree)]
    lower_education = df[~df["education"].isin(degree)]
